...
[一點一滴的進步: [ASP.NET MVC] 登入後，自動導向使用者原本Request的Url](https://minicoding.blogspot.com/2016/12/aspnet-mvc-requesturl.html)
...
個別帳戶(目前使用):  
指定資料庫建立使用者、權限、...等資料表。  
(連結字串有問題的請至"【程式開發筆記】SQL Server Connection String Generator")
